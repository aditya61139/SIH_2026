...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="rounded-2xl bg-[#1A1C23] p-6 border border-[#2A2E37] shadow-xl">
        <div className="flex items-center space-x-3 mb-6">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#15171C] border border-[#2A2E37] text-[#10B981]">
        ...
        {/* Server Endpoints */}
        <div className="space-y-4 pb-6 border-b border-[#252830]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="text-xs text-[#E2E8F0] font-medium block mb-1">
              ...
              <input
                ...
                className="w-full rounded-xl bg-[#15171C] border border-[#2A2E37] px-3.5 py-2 text-xs font-mono text-white focus:border-[#10B981] focus:outline-none"
              />
            </div>
            <div>
              <label className="text-xs text-[#E2E8F0] font-medium block mb-1">
        ...
        <div className="py-6 border-b border-[#252830] space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono font-bold text-[#10B981] bg-[#10B981]/10 px-2.5 py-1 rounded-lg border border-[#10B981]/30">
        ...
        <div className="py-6 border-b border-[#252830] space-y-4">
          ...
          <div className="space-y-3">
            <label className="flex items-center justify-between p-3 rounded-xl bg-[#15171C] border border-[#2A2E37] cursor-pointer">
              <div>
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <button
            onClick={handleSave}
            className="flex items-center space-x-2 rounded-xl bg-[#10B981] hover:bg-[#059669] text-[#0D0E11] px-5 py-2.5 text-xs font-bold shadow-lg shadow-[#10B981]/25 transition-all"
          >
            {saved ? (
              <>
